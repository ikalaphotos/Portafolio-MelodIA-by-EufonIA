...
print("Iniciando Fase 1: Generación de Dataset Simulado (Mocking)...")
print("API de Spotify bloqueada (403). Pivotando a generación de datos locales.")

# --- 1. Definición de la Hipótesis (Método EufonIA) ---
# Definimos las "firmas" sónicas que esperamos de cada fase.
# (Media, Desviación Estándar) para la generación aleatoria.
...
N_SAMPLES_PER_CATEGORY = 200 # Generamos 200 canciones por categoría

def generate_songs_for_phase(categoria, spec):
    """
    Genera un DataFrame de canciones simuladas para una fase específica.
    """
    ...
    # Simulamos otras métricas que KNIME analizará
    ...
    # Nos aseguramos de que los valores estén en el rango correcto (0.0 a 1.0)
...
def create_mock_dataset():
    ...
    print("\n" + "="*50)
    print(f"¡ÉXITO! Dataset simulado creado: {output_filename}")
    ...
    print("¡Ya estamos listos para la Fase 2 en KNIME!")
